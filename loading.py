...
class LoadingScreen(Screen):
    ...
    skin = """<screen position="530,590" size="600,70" title="EasyBouquet" flags="wfNoBorder">
    ...
    def __init__(self, session):
        ...
        self.fechar = eTimer()
        self.execusao = eTimer()
        self.fechar.callback.append(self.close)
    
        self["progress"].setValue(0)
        self["progress"].show()
        self.execusao.callback.append(self.processar)
        self.execusao.start(100,1)
    ...
    def gerarBouquets(self):
            ...
            if self.parserules():
                ...
                self.satPref=utils.positionToSat(config.plugins.Easy.pref.value)
